    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            <label for="recipient-name" class="control-label">
                班级编号：</label>
            <%: Html.TextBoxFor(model => model.cl_id, new { @class = "form-control", @ReadOnly = true })%>
            <%: Html.ValidationMessageFor(model => model.cl_id)%>
        </div>
        <div class="form-group">
            <label for="recipient-name" class="control-label">
                班级名称：</label>
        ...
        <div class="form-group">
            <label for="recipient-name" class="control-label">
                所属专业：</label>
            <%: Html.DropDownListFor(model => model.cl_spid,ViewData["sp"] as IEnumerable<SelectListItem>,new { @class = "form-control" })%>
